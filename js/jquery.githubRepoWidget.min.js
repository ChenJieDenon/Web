jQuery(document).ready(function (e) {
  ...
  e(".github-widget").each(function () {
    if (t == 0) e("head").append('<style type="text/css">' +
      ...
      ".github-box .github-box-title h3{word-wrap:break-word;font-family:helvetica,arial,sans-serif;font-weight:normal;font-size:16px;color:gray;margin:0;padding:10px 10px 10px 30px;background:url(" +
      n + ") 7px center no-repeat; width: auto;}" +
      ...
      ".github-box .github-box-title .github-stats a{display:inline-block;height:21px;color:#666;border:1px solid #ddd;border-radius:3px;padding:0 5px 0 18px;background: white url(" +
      r + ") no-repeat}" +
    ...
    o = e('<div class="github-box repo">' +
      '<div class="github-box-title">' + "<h3>" +
      '<a class="owner" href="' + l + '" title="' + l + '">' + a +
      "</a>" + "/" + '<a class="repo" href="' + c + '" title="' + c +
      '">' + f + "</a>" + "</h3>" + '<div class="github-stats">' +
      '<a class="watchers" href="' + c +
      '/watchers" title="See watchers">?</a>' +
      '<a class="forks" href="' + c +
      '/network/members" title="See forkers">?</a>' + "</div>" +
      "</div>" + '<div class="github-box-content">' +
      '<p class="description"><span></span> — <a href="' + c +
      '#readme">Read More</a></p>' + '<p class="link"></p>' +
      "</div>" + '<div class="github-box-download">' +
      '<div class="updated"></div>' + '<a class="download" href="' +
      c +
    ...
    e.ajax({
      ...
      success: function (t) {
        ...
        if (n.pushed_at) {
          ...
          i = r.getMonth() + 1 + "-" + r.getDate() + "-" + r
            .getFullYear()
        }
        o.find(".watchers").text(n.watchers);
        o.find(".forks").text(n.forks);
        o.find(".description span").text(n.description);
        o.find(".updated").html("Latest commit to the <strong>" +
          n.default_branch + "</strong> branch on " + i);
        if (n.homepage != null) o.find(".link").append(e("<a />")
          .attr("href", n.homepage).text(n.homepage))
      }
    })
  })
});
